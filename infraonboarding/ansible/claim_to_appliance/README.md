...
- recent verification confirmed successful appliance-side `DeviceClaims` creation for
  all submitted targets even when the returned claim status is still `started`
